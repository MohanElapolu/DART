...
const ObjParPath =  path.resolve(__dirname, 'contracts', 'ParObj.sol');
//read the content of the file
const source    =  fs.readFileSync(ObjParPath, 'utf8');
...
module.exports = JSON.parse(solc.compile(JSON.stringify(input))).contracts['ParObj.sol'].ParObj;